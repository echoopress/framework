...
abstract class Controller
{
    ...
    {
        return $this->container->get('routing')->generateUrl($route, $parameters, $referenceType);
    }
    ...
    {
        if ($this->container->has('templating')) {
            return new Response($this->container->get('templating')->render($view, $parameters, $response));
        }
...
//    }
    ...
    protected function hasPackage($id)
    {
        return $this->has('package_',$id);
    }
